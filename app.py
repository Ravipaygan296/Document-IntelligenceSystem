...
with st.sidebar:
    ...
    api_provider = st.selectbox("LLM Provider", ["Groq (Free)", "Google Gemini (Free)"], label_visibility="collapsed")
    ...
    if api_key:
        ...
        st.markdown('<div class="success-banner">✓ API Key configured</div>', unsafe_allow_html=True)
...
if not st.session_state.docs_processed:
    ...
    <div style="text-align:center; padding: 4rem 2rem;">
        ...
        <p style="color: #7a7a9a; font-size: 0.95rem; max-width: 500px; margin: 0 auto 2rem;">
            Upload your PDFs in the sidebar, configure your free API key, and start asking questions with full source citations.
        </p>
    </div>
    """, unsafe_allow_html=True)
